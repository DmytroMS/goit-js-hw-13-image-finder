...
var NewApiService = /*#__PURE__*/function () {
  ...
  _createClass(NewApiService, [{
    ...
    value: function fetchArticle() {
      ...
      fetch("".concat(URL, "?image_type=photo&orientation=horizontal&q=").concat(this.searchQuery, "&page=1&per_page=12&key=").concat(API_KEY)).then(function (r) {
        return r.json();
      }).then(console.log);
    }
  }, {
...
// }
// fetchPictures();
},{"./src/apiService":"src/apiService.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
